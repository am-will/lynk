...
export const selectedChatBackendModelSchema = z.string().min(1).refine((value) => {
  ...
  return /^(hermes|codex|opencode|pi|devin):\S+$/.test(trimmed);
}, "Expected a bare OpenClaw model id, a Hermes/Codex/OpenCode/Pi/Devin namespaced model id, or local-litertlm");
