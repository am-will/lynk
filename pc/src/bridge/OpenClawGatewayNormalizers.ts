...
export function normalizeSessions(value: unknown): ChatSessionSummary[] {
  ...
  for (const item of sessions) {
    ...
    normalized.push({
      ...
      ...(stringField(record, "harnessId") ? { harnessId: stringField(record, "harnessId") } : {}),
      ...(stringField(record, "harnessLabel") ? { harnessLabel: stringField(record, "harnessLabel") } : {}),
      ...(stringField(record, "workspacePath") ? { workspacePath: stringField(record, "workspacePath") } : {}),
      ...(stringField(record, "workspaceName") ? { workspaceName: stringField(record, "workspaceName") } : {}),
      ...(stringField(record, "threadPath") ? { threadPath: stringField(record, "threadPath") } : {}),
